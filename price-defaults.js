...
export const SPIRAL_DEFAULTS = {
  ...
  // Spiral Spin-In / round tap pricing
  'spiral-spin-in-4':  { '26': 0.62 },
  'spiral-spin-in-5':  { '26': 0.74 },
  'spiral-spin-in-6':  { '26': 0.84 },
  'spiral-spin-in-7':  { '26': 0.92 },
  'spiral-spin-in-8':  { '26': 1.00 },
  'spiral-spin-in-9':  { '26': 1.10 },
  'spiral-spin-in-10': { '26': 1.32 },
  'spiral-spin-in-12': { '26': 1.56 },
  'spiral-spin-in-14': { '26': 1.78 },
  'spiral-spin-in-16': { '26': 2.08 },
  'spiral-spin-in-18': { '26': 2.28 },
  'spiral-spin-in-20': { '26': 2.58 },
  'spiral-spin-in-22': { '26': 2.88 },
  'spiral-spin-in-24': { '26': 3.18 },
  // Spiral Round Volume Damper pricing
  'spiral-volume-damper-4':  { '26': 2.50 },
  'spiral-volume-damper-5':  { '26': 3.05 },
  'spiral-volume-damper-6':  { '26': 3.10 },
  'spiral-volume-damper-7':  { '26': 3.45 },
  'spiral-volume-damper-8':  { '26': 3.90 },
  'spiral-volume-damper-9':  { '26': 4.01 },
  'spiral-volume-damper-10': { '26': 4.40 },
  'spiral-volume-damper-12': { '26': 5.163 },
  'spiral-volume-damper-14': { '26': 5.25 },
  'spiral-volume-damper-16': { '26': 5.90 },
  'spiral-volume-damper-18': { '26': 6.454 },
  'spiral-volume-damper-20': { '26': 7.70 },
...
export const SNAPLOCK_DEFAULTS = {
  ...
  'snaplock-spin-in-4':  { '26': 0.62 },
  'snaplock-spin-in-5':  { '26': 0.74 },
  'snaplock-spin-in-6':  { '26': 0.84 },
  'snaplock-spin-in-7':  { '26': 0.92 },
  'snaplock-spin-in-8':  { '26': 1.00 },
  'snaplock-spin-in-9':  { '26': 1.10 },
  'snaplock-spin-in-10': { '26': 1.32 },
  'snaplock-spin-in-12': { '26': 1.56 },
  'snaplock-spin-in-14': { '26': 1.78 },
  'snaplock-spin-in-16': { '26': 2.08 },
  'snaplock-spin-in-18': { '26': 2.28 },
  'snaplock-spin-in-20': { '26': 2.58 },
  'snaplock-spin-in-22': { '26': 2.88 },
  'snaplock-spin-in-24': { '26': 3.18 },
...
export const RECT_FITTING_SA = {
  ...
  'rect-tapIncreasedArea': function(W, H) {
    const throat = 4;
    const skirt = 6;
    return ((2 * (W + H) * throat) + ((W + skirt * 2) * (H + skirt * 2))) / 144;
  },
